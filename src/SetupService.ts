...
export class SetupService
{
  public async AddDefaultDevContextIfNotExists() {
    let testInput: ContextInput = { context: "development", loginApiServerUrl: "http://localhost:7878", apiGatewayAdminUrl: "http://localhost:8002", apiServerUrl: "http://localhost:7878", isDefaultContext: true }; 
